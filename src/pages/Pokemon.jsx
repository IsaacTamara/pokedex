...
const Pokemon = () => {
  ...
  const getPercentageBarProgress = (valueStat) => {
    const maxValue = 150
    ...
    <main className='Pokemon'>
      <section className='pokemonId'>
        ...
        <section className='pokemonId__info'>
          <div className='pokemonId__info-conteiner'>
                ...
                dataPokemon?.stats.map(stat => (
                  <div key={stat.stat.name} className='pokemonId__stat'>
                    ...
                    <div className='pokemonId__stat-bar'>
                      <div style={{width: getPercentageBarProgress(stat.base_stat)}} className='pokemonId__stat-barProgress'></div>
                    </div>
                  </div>
                ))
              }
