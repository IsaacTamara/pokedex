  ...
  return (
    ...
    >
      ...
      <section className="loader">
        <div
          className={`loader__section up ${
            dataPokemon ? "animationActive" : ""
          }`}
        >
          <div className="loader__black up">
            <div className="loader__circle">
              <div className="loader__circle-inte"></div>
            </div>
          </div>
        </div>
        <div
          className={`loader__section down ${
            dataPokemon ? "animationActive" : ""
          }`}
        >
          <div className="loader__black down"></div>
        </div>
      </section>
    </article>
  );
